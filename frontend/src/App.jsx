...
const tabs = ["Overview", "TwinSpace", "Intelligence", "Readiness", "Upgrades", "Deploy", "Showcase", "Collaborate"];
...
export default function App() {
  ...
  const pages = { Overview: <Overview twin={twin} setActive={changeView} onAI={openAI} opened={overviewOpen} onOpen={openProject} onBack={() => setOverviewOpen(false)} view={projectView} setView={setProjectView} requestConfirm={requestConfirm} notify={notify} onAsk={() => setAskOpen(true)} />, TwinSpace: <TwinSpaceApp />, Discover: <Discover twin={twin} setActive={changeView} />, Activity: <ActivityView twin={twin} setActive={changeView} notify={notify} />, Intelligence: <Intelligence twin={twin} onAI={openAI} />, Readiness: <Readiness twin={twin} onAI={openAI} />, Upgrades: <Upgrades twin={twin} notify={notify} requestConfirm={requestConfirm} />, Deploy: <Deploy twin={twin} requestConfirm={requestConfirm} notify={notify} onAI={openAI} />, Showcase: <Showcase twin={twin} requestConfirm={requestConfirm} notify={notify} onAsk={() => setAskOpen(true)} onSelectTwin={openProject} />, Collaborate: <CollaborationWorkspace twin={twin} /> };
